...
urlpatterns = [
    ...
    path("<int:pk>/offer/", views.offer_price, name="offer"),
    path("<int:pk>/offer/accept/", views.accept_offer, name="accept_offer"),
    path("<int:pk>/offer/decline/", views.decline_offer, name="decline_offer"),
